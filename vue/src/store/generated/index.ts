...
import CosmonautLoanCosmonautLoanLoan from './cosmonaut/loan/cosmonaut.loan.loan'
...
export default { 
  CosmonautLoanCosmonautLoanLoan: load(CosmonautLoanCosmonautLoanLoan, 'cosmonaut.loan.loan'),

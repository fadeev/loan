...
export const QueryGetLoanRequest = {
  encode(message: QueryGetLoanRequest, writer: Writer = Writer.create()): Writer {
    if (message.id !== 0) {
...
export const QueryGetLoanResponse = {
  encode(message: QueryGetLoanResponse, writer: Writer = Writer.create()): Writer {
...
export const QueryAllLoanRequest = {
  encode(message: QueryAllLoanRequest, writer: Writer = Writer.create()): Writer {
...
export const QueryAllLoanResponse = {
  encode(message: QueryAllLoanResponse, writer: Writer = Writer.create()): Writer {
